...
-- Trigger: Limite de Depósito Diário
DELIMITER $$
...
-- Procedure: Calcular Score de Crédito
DELIMITER $$
...
BEGIN
    ...
    SELECT IFNULL(SUM(valor),0), IFNULL(AVG(valor),0)
...
-- View: Movimentações Recentes (últimos 90 dias)
